...
def toggle_display():
    check_call("sudo /home/pi/oled_phoniebox/scripts/toggle_display/toggle_display.sh", shell=True)
...
btn_prev = Button(13,pull_up=True,hold_time=2.0,hold_repeat=False)
btn_halt = Button(6,pull_up=True,hold_time=2.0,hold_repeat=False)
